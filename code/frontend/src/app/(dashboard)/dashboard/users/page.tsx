  ...
  return (
    <div className="ops-page mx-auto w-full max-w-[1600px] space-y-10 p-6 md:p-10">
      ...
      <div className="space-y-6">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3" role="status" aria-label={localize("Đang tải dữ liệu người dùng", "Loading user data")}>
            {[0, 1, 2, 3, 4, 5].map((item) => <div key={item} className="rounded-xl border border-[#0F2A43]/10 bg-white p-6"><div className="flex items-center gap-3"><div className="h-10 w-10 animate-pulse rounded-full bg-[#E5E9ED]" /><div className="flex-1 space-y-2"><div className="h-5 w-1/2 animate-pulse rounded bg-[#E5E9ED]" /><div className="h-4 w-3/4 animate-pulse rounded bg-[#E5E9ED]" /></div></div><div className="mt-6 h-20 animate-pulse rounded-lg bg-[#F1F0EA]" /></div>)}
          </div>
